"""
this algorithm takes the desired amount of clusters between 5 and 17 as input.
The algorithm returns a grid with the desired amount of clusters
...
def KmeansClusterdistance(h, b, k):
    ...
    while startover < k:
        ...
        for i in k_list:
            ...
            if oldclustercenters[i][0] == clustercenters[i][0] and \
               oldclustercenters[i][1] == clustercenters[i][1]:
                startover += 1
