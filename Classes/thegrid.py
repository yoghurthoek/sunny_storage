...
class Grid():
    ...
    def __init__(self, nr):
        ...
        batteryload = os.path.dirname(os.getcwd()) + \
            f"\\sunny_storage\\Data\\wijk{nr}_batterijen.csv"
        housesload = os.path.dirname(os.getcwd()) + \
            f"\\sunny_storage\\Data\\wijk{nr}_huizen.csv"
